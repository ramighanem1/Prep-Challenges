...
const objLat = (obj) => {
    ...
    return `my name is ${firstNameUpper} ${lastNameUpper} I am ${obj.age} YO, and I love ${obj.hobby}.`;
};
// -------------------------------------------------------------------------------------------------------
    ...
    for (let i = 0; i < arr.length; i++) {
        if (arr[i].yearsOfExperience > 1) {
            ...
            if (arr[i].firstName != null) {
                fullNameStr += arr[i].firstName;
            }
            if (arr[i].lastName != null) {
                fullNameStr += " ";
                fullNameStr += arr[i].lastName;
            }

            Output.push({ fullName: fullNameStr, tech: arr[i].tech });
        }
    }
    return Output;
};
